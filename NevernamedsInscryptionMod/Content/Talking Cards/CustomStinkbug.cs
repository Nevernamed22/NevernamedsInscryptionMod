...
namespace NevernamedsInscryptionMod
{
    static class CustomStinkbug
    {
        ...
        }, new List<List<CustomLine>>
        {
            ...
            #endregion
            SpecialTriggeredAbility ability = SpecialTriggeredAbilityManager.Add("nevernamedscustominscryptioncards", "CustomStinkbugTalker", typeof(CustomStinkbugTalker)).Id;


            // Add the card
            CardSetupUtility.NewCard("Nevernamed CustomStinkbug",
                "Stinkbug",
                1,
                2,
    ...
    public class CustomStinkbugTalker : PaperTalkingCard
    {
