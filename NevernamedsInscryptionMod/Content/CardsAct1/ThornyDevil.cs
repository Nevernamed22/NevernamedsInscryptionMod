    ...
    static class ThornyDevil
    {
        public static void Init()
        {
            ...
            CardSetupUtility.NewCard("Nevernamed ThornyTail",
                ...
                bloodCost: 0,
                bonesCost: 0,
                  pixelTex: Tools.LoadTex("NevernamedsInscryptionMod/Resources/PixelCards/thornytail_pixel.png"),
            ...
            CardSetupUtility.NewCard("Nevernamed ThornyDevil",
                ...
                tribes: new List<Tribe>() { Tribe.Reptile },
                  pixelTex: Tools.LoadTex("NevernamedsInscryptionMod/Resources/PixelCards/thornydevil_pixel.png"),
