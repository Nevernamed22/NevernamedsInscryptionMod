    ...
    static class TrapjawAnt
    {
        public static void Init()
        {
            ...
            CardSetupUtility.NewCard("Nevernamed TrapjawAnt",
                ...
                0,
                1,
                new List<CardMetaCategory> { CardMetaCategory.TraderOffer, CardMetaCategory.ChoiceNode, CardMetaCategory.GBCPack, CardMetaCategory.GBCPlayable },
                CardTemple.Nature,
                ...
                pixelTex: Tools.LoadTex("NevernamedsInscryptionMod/Resources/PixelCards/trapjawant_pixel.png"),
